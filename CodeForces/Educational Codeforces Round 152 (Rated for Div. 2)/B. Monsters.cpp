...
#define sort_vector_rev(v) sort((v).rbegin(), (v).rend())
#define sort_array(a,n) sort((a), (a)+(n))
#define sort_array_rev(a,n) sort((a), (a)+(n), greater<int>())
#define sort_map_by_key(m) map<int,int> sorted_m((m).begin(), (m).end())
#define sort_map_by_value(m) vector<pair<int,int>> sorted_m_vec; fmap_int(k,v,m) { sorted_m_vec.pb({k,v}); } sort(sorted_m_vec.begin(), sorted_m_vec.end(), [](pair<int,int> &a, pair<int,int> &b) { return a.second < b.second; });
#define sort_map_by_key_rev(m) map<int,int, greater<int>> sorted_m((m).begin(), (m).end())
#define sort_map_by_value_rev(m) vector<pair<int,int>> sorted_m_vec; fmap_int(k,v,m) { sorted_m_vec.pb({k,v}); } sort(sorted_m_vec.begin(), sorted_m_vec.end(), [](pair<int,int> &a, pair<int,int> &b) { return a.second > b.second; });
...
void solve() {
    ...
    sort(v.begin(), v.end(), [](const pair<ll,int>& x, const pair<ll,int>& y) {
