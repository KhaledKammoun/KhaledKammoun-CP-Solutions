...
void solve() {
    ...
    ll sumSecond = 0;
    int globalMinFirst = INT_MAX;
    int globalMinSecond = INT_MAX;
    ...
    f0(i, n) {
        ...
        globalMinFirst = min(globalMinFirst, mn1);
        globalMinSecond = min(globalMinSecond, mn2);
        sumSecond += mn2;
    }

    ll result = sumSecond - globalMinSecond + globalMinFirst;
    cout << result << endl;
